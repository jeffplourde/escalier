...
public class TwitDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements TwitDataReaderView
{
    private long copyCache;
    private TwitTypeSupport typeSupport;

    public TwitDataReaderViewImpl(dds.demo.twitter.gen.TwitTypeSupport ts)
    {
        typeSupport = ts;
