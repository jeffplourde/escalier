...
public class SimplePayloadDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SimplePayloadDataWriter
{
    private long copyCache;
    private SimplePayloadTypeSupport typeSupport;

    public SimplePayloadDataWriterImpl(org.opensplice.perf.SimplePayloadTypeSupport ts)
    {
        typeSupport = ts;
