...
public class Canvas2DDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements Canvas2DDataReader
{
    private long copyCache;
    private Canvas2DTypeSupport typeSupport;

    public Canvas2DDataReaderImpl(org.opensplice.demo.Canvas2DTypeSupport ts)
    {
        typeSupport = ts;
