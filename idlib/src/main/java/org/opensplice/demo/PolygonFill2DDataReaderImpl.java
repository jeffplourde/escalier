...
public class PolygonFill2DDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements PolygonFill2DDataReader
{
    private long copyCache;
    private PolygonFill2DTypeSupport typeSupport;

    public PolygonFill2DDataReaderImpl(org.opensplice.demo.PolygonFill2DTypeSupport ts)
    {
        typeSupport = ts;
