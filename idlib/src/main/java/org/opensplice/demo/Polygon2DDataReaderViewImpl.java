...
public class Polygon2DDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements Polygon2DDataReaderView
{
    private long copyCache;
    private Polygon2DTypeSupport typeSupport;

    public Polygon2DDataReaderViewImpl(org.opensplice.demo.Polygon2DTypeSupport ts)
    {
        typeSupport = ts;
