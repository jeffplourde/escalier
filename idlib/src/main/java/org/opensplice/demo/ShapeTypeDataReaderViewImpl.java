...
public class ShapeTypeDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements ShapeTypeDataReaderView
{
    private long copyCache;
    private ShapeTypeTypeSupport typeSupport;

    public ShapeTypeDataReaderViewImpl(org.opensplice.demo.ShapeTypeTypeSupport ts)
    {
        typeSupport = ts;
