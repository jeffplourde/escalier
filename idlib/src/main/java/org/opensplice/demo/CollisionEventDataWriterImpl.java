...
public class CollisionEventDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CollisionEventDataWriter
{
    private long copyCache;
    private CollisionEventTypeSupport typeSupport;

    public CollisionEventDataWriterImpl(org.opensplice.demo.CollisionEventTypeSupport ts)
    {
        typeSupport = ts;
