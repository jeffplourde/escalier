...
public class CollisionEventDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements CollisionEventDataReader
{
    private long copyCache;
    private CollisionEventTypeSupport typeSupport;

    public CollisionEventDataReaderImpl(org.opensplice.demo.CollisionEventTypeSupport ts)
    {
        typeSupport = ts;
