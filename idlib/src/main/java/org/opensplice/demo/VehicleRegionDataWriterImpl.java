...
public class VehicleRegionDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements VehicleRegionDataWriter
{
    private long copyCache;
    private VehicleRegionTypeSupport typeSupport;

    public VehicleRegionDataWriterImpl(org.opensplice.demo.VehicleRegionTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.opensplice.demo.VehicleRegion instance_data)
    {
        return
