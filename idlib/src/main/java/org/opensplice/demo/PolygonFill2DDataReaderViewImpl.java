...
public class PolygonFill2DDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements PolygonFill2DDataReaderView
{
    private long copyCache;
    private PolygonFill2DTypeSupport typeSupport;

    public PolygonFill2DDataReaderViewImpl(org.opensplice.demo.PolygonFill2DTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            org.opensplice.demo.PolygonFill2DSeqHolder received_data, 
    ...
    public int read_next_sample(
            org.opensplice.demo.PolygonFill2DHolder received_data, 
    ...
    public int get_key_value(
            org.opensplice.demo.PolygonFill2DHolder key_holder, 
            long handle)
    {
        return
	...
	org.opensplice.demo.PolygonFill2D instance)
    {
        return
