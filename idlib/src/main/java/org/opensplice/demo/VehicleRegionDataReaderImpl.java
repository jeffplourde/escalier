...
public class VehicleRegionDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements VehicleRegionDataReader
{
    private long copyCache;
    private VehicleRegionTypeSupport typeSupport;

    public VehicleRegionDataReaderImpl(org.opensplice.demo.VehicleRegionTypeSupport ts)
    {
        typeSupport = ts;
