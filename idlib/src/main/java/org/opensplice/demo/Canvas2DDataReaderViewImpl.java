...
public class Canvas2DDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements Canvas2DDataReaderView
{
    private long copyCache;
    private Canvas2DTypeSupport typeSupport;

    public Canvas2DDataReaderViewImpl(org.opensplice.demo.Canvas2DTypeSupport ts)
    {
        typeSupport = ts;
