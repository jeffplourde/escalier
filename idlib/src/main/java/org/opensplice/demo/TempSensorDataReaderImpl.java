...
public class TempSensorDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements TempSensorDataReader
{
    private long copyCache;
    private TempSensorTypeSupport typeSupport;

    public TempSensorDataReaderImpl(org.opensplice.demo.TempSensorTypeSupport ts)
    {
        typeSupport = ts;
