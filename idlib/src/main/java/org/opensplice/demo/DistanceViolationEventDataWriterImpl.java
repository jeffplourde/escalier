...
public class DistanceViolationEventDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements DistanceViolationEventDataWriter
{
    private long copyCache;
    private DistanceViolationEventTypeSupport typeSupport;

    public DistanceViolationEventDataWriterImpl(org.opensplice.demo.DistanceViolationEventTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.opensplice.demo.DistanceViolationEvent instance_data)
    {
        return
