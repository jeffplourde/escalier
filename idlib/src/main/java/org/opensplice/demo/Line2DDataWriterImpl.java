...
public class Line2DDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements Line2DDataWriter
{
    private long copyCache;
    private Line2DTypeSupport typeSupport;

    public Line2DDataWriterImpl(org.opensplice.demo.Line2DTypeSupport ts)
    {
        typeSupport = ts;
