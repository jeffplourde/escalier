...
public class Shape2DDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements Shape2DDataReaderView
{
    private long copyCache;
    private Shape2DTypeSupport typeSupport;

    public Shape2DDataReaderViewImpl(org.opensplice.demo.Shape2DTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            org.opensplice.demo.Shape2DSeqHolder received_data, 
    ...
    public int read_next_sample(
            org.opensplice.demo.Shape2DHolder received_data, 
    ...
    public int get_key_value(
            org.opensplice.demo.Shape2DHolder key_holder, 
            long handle)
    {
        return
	...
	org.opensplice.demo.Shape2D instance)
    {
        return
