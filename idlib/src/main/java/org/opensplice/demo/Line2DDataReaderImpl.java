...
public class Line2DDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements Line2DDataReader
{
    private long copyCache;
    private Line2DTypeSupport typeSupport;

    public Line2DDataReaderImpl(org.opensplice.demo.Line2DTypeSupport ts)
    {
        typeSupport = ts;
