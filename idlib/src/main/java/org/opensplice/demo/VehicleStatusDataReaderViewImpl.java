...
public class VehicleStatusDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements VehicleStatusDataReaderView
{
    private long copyCache;
    private VehicleStatusTypeSupport typeSupport;

    public VehicleStatusDataReaderViewImpl(org.opensplice.demo.VehicleStatusTypeSupport ts)
    {
        typeSupport = ts;
