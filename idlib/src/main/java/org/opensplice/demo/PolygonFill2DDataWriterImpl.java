...
public class PolygonFill2DDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PolygonFill2DDataWriter
{
    private long copyCache;
    private PolygonFill2DTypeSupport typeSupport;

    public PolygonFill2DDataWriterImpl(org.opensplice.demo.PolygonFill2DTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.opensplice.demo.PolygonFill2D instance_data)
    {
        return
