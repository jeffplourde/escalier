...
public class Polygon2DDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements Polygon2DDataReader
{
    private long copyCache;
    private Polygon2DTypeSupport typeSupport;

    public Polygon2DDataReaderImpl(org.opensplice.demo.Polygon2DTypeSupport ts)
    {
        typeSupport = ts;
