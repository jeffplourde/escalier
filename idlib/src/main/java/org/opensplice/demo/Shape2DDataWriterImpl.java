...
public class Shape2DDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements Shape2DDataWriter
{
    private long copyCache;
    private Shape2DTypeSupport typeSupport;

    public Shape2DDataWriterImpl(org.opensplice.demo.Shape2DTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.opensplice.demo.Shape2D instance_data)
    {
        return
