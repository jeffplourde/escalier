...
public class VehicleStatusDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements VehicleStatusDataReader
{
    private long copyCache;
    private VehicleStatusTypeSupport typeSupport;

    public VehicleStatusDataReaderImpl(org.opensplice.demo.VehicleStatusTypeSupport ts)
    {
        typeSupport = ts;
