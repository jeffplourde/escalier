...
public class DistanceViolationEventDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements DistanceViolationEventDataReader
{
    private long copyCache;
    private DistanceViolationEventTypeSupport typeSupport;

    public DistanceViolationEventDataReaderImpl(org.opensplice.demo.DistanceViolationEventTypeSupport ts)
    {
        typeSupport = ts;
