...
public class DistanceViolationEventDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements DistanceViolationEventDataReaderView
{
    private long copyCache;
    private DistanceViolationEventTypeSupport typeSupport;

    public DistanceViolationEventDataReaderViewImpl(org.opensplice.demo.DistanceViolationEventTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public int read(
            org.opensplice.demo.DistanceViolationEventSeqHolder received_data, 
    ...
    public int read_next_sample(
            org.opensplice.demo.DistanceViolationEventHolder received_data, 
    ...
    public int get_key_value(
            org.opensplice.demo.DistanceViolationEventHolder key_holder, 
            long handle)
    {
        return
	...
	org.opensplice.demo.DistanceViolationEvent instance)
    {
        return
