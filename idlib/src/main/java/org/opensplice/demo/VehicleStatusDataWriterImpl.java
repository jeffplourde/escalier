...
public class VehicleStatusDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements VehicleStatusDataWriter
{
    private long copyCache;
    private VehicleStatusTypeSupport typeSupport;

    public VehicleStatusDataWriterImpl(org.opensplice.demo.VehicleStatusTypeSupport ts)
    {
        typeSupport = ts;
