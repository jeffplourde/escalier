...
public class Polygon2DDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements Polygon2DDataWriter
{
    private long copyCache;
    private Polygon2DTypeSupport typeSupport;

    public Polygon2DDataWriterImpl(org.opensplice.demo.Polygon2DTypeSupport ts)
    {
        typeSupport = ts;
