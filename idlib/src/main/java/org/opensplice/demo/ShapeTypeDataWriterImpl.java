...
public class ShapeTypeDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ShapeTypeDataWriter
{
    private long copyCache;
    private ShapeTypeTypeSupport typeSupport;

    public ShapeTypeDataWriterImpl(org.opensplice.demo.ShapeTypeTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            org.opensplice.demo.ShapeType instance_data)
    {
        return
