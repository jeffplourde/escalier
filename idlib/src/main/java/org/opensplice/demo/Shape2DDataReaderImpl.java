...
public class Shape2DDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements Shape2DDataReader
{
    private long copyCache;
    private Shape2DTypeSupport typeSupport;

    public Shape2DDataReaderImpl(org.opensplice.demo.Shape2DTypeSupport ts)
    {
        typeSupport = ts;
