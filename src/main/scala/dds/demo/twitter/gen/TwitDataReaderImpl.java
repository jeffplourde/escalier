...
public class TwitDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements TwitDataReader
{
    private long copyCache;
    private TwitTypeSupport typeSupport;

    public TwitDataReaderImpl(dds.demo.twitter.gen.TwitTypeSupport ts)
    {
        typeSupport = ts;
