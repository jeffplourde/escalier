...
public class ShapeTypeDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements ShapeTypeDataReader
{
    private long copyCache;
    private ShapeTypeTypeSupport typeSupport;

    public ShapeTypeDataReaderImpl(org.opensplice.demo.ShapeTypeTypeSupport ts)
    {
        typeSupport = ts;
