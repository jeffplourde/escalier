...
public class SeqPayloadDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SeqPayloadDataReaderView
{
    private long copyCache;
    private SeqPayloadTypeSupport typeSupport;

    public SeqPayloadDataReaderViewImpl(org.opensplice.perf.SeqPayloadTypeSupport ts)
    {
        typeSupport = ts;
