...
public class SimplePayloadDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SimplePayloadDataReaderView
{
    private long copyCache;
    private SimplePayloadTypeSupport typeSupport;

    public SimplePayloadDataReaderViewImpl(org.opensplice.perf.SimplePayloadTypeSupport ts)
    {
        typeSupport = ts;
