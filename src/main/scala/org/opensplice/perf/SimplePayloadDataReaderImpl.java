...
public class SimplePayloadDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SimplePayloadDataReader
{
    private long copyCache;
    private SimplePayloadTypeSupport typeSupport;

    public SimplePayloadDataReaderImpl(org.opensplice.perf.SimplePayloadTypeSupport ts)
    {
        typeSupport = ts;
