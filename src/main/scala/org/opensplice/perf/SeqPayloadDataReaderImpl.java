...
public class SeqPayloadDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SeqPayloadDataReader
{
    private long copyCache;
    private SeqPayloadTypeSupport typeSupport;

    public SeqPayloadDataReaderImpl(org.opensplice.perf.SeqPayloadTypeSupport ts)
    {
        typeSupport = ts;
